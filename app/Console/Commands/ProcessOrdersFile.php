    ...
    public function handle()
    {
        ...
        foreach ($inputFiles as $inputFilePath) {
            ...
            if ($firstColumn === '007850 001') {
                ...
                $logData[] = $this->generateLogMessage("Condition 1 met: {$fileName} - Orden de Nadro");
                ...
                $logData[] = $this->generateLogMessage("Condition 2 met: {$fileName} - Orden de Walmart");
                ...
                $logData[] = $this->generateLogMessage("Condition 3 met: {$fileName} - Orden de Chedraui");
            } else {
            ...
            $logData[] = $this->generateLogMessage("Processed successfully: {$fileName} - Moved to translate_process.");
            $this->logToFile($logFilePath, $logData);
        }
